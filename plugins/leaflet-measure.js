(function (factory, window) {
    ...
    L.MeasureAction = L.Handler.extend({
        ...
        _getAreaString: function (points) {
            ...
            return Math.round(a) > 1e4
                ? this._numberFormat(a / 1e4, L.Measure.hectaresDecimals) + " " + L.Measure.hectares
...
_getFormattedArea: function (a) {
    return this._numberFormat(a / 1e4, L.Measure.hectaresDecimals) + " " + L.Measure.hectares;
}
    });
